       ...
       @endif
          <section>
                ...
                <div class="text-center text-capitalize ">
                    <h2 class="font-weight-bold">Introduction to computer Gamified post survey</h2>
            ...
            <!--section 2-->
            <section>
            <form method="post" action="{{route('survey.post',$id)}}">
            @csrf

                <div class="body-top my-4">
                  
                        <!--<h4 class="my-4"> Please if you've submitted survey before just enter your student number and click submit thanks!</h4>-->
                    ...
                    <div class="row">
                        <div class="col-md-12">   
                            <button type="submit" name="submit" value="course" class="btn btn-dark  btn-lg btn-block">Submit Form</button>
                        </div>
                    </div>
